...
import co.yiiu.hitbbs.config.realm.MyCredentialsMatcher;
import co.yiiu.hitbbs.config.realm.MyShiroRealm;
...
//        map.put("/admin/user/**", "user");
    ...
    public CookieRememberMeManager rememberMeManager() {
        ...
        cookieRememberMeManager.setCipherKey(Base64.encode("hitbbs is the best!".getBytes()));
