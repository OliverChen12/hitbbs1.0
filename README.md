> 使用说明：请在醒目的地方标明 powered by hitbbs
...
[捐赠列表](https://github.com/atjiu/hitbbs/wiki/%E6%8D%90%E8%B5%A0)

## 文档

[文档地址](https://atjiu.github.io/hitbbs/)
...
还是看文档吧，更详细 [传送门](https://NPEteam92.github.io/hitbbs/#%E5%BF%AB%E9%80%9F%E5%BC%80%E5%A7%8B)
...
打包完成后，会在项目根目录下的target目录里生成一个`hitbbs.jar`文件，解压运行 `java -jar hitbbs.jar` 即可启动论坛服务
...
| :----------- | :------------------------------------------------------------------ | :------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------- | :---- | :------------------------------------------------------------------ | :--------------------------------------------------------------------------- | :------------------------------------------ |
| 开源地址     | [传送门](https://github.com/atjiu/hitbbs/tree/v2.2)               | [传送门](https://github.com/atjiu/hitbbs/tree/v2.3)   | [传送门](https://github.com/atjiu/hitbbs/tree/v2.4)                                                                            | [传送门](https://github.com/atjiu/hitbbs/tree/v2.6) |       | [传送门](https://github.com/atjiu/hitbbs/tree/v3.0)                | [传送门](https://github.com/atjiu/hitbbs/tree/v4.0-mongodb-api)            | [传送门](https://github.com/atjiu/hitbbs) |
...
| 编辑器       | [WangEditor(富文本)](https://github.com/wangfupeng1988/wangEditor/) | [editor(Markdown)](https://github.com/lepture/editor)   | 可切换 [editor(Markdown)](https://github.com/lepture/editor) [WangEditor(富文本)](https://github.com/wangfupeng1988/wangEditor/) | [hiteditor](https://github.com/atjiu/hiteditor)      |       | [WangEditor(富文本)](https://github.com/wangfupeng1988/wangEditor/) |                                                                              | [CodeMirror](https://codemirror.net/)       |
...
| 国际化       |                                                                     |                                                         | &radic;                                                                                                                          |                                                       |       |                                                                     |                                                                              ||
| APP          |                                                                     | [hitbbsMD(Android)](https://github.com/atjiu/hitbbsMD) |                                                                                                                                  |                                                       |       |                                                                     |                                                                              ||
| 前端         |                                                                     |                                                         |                                                                                                                                  |                                                       |       |                                                                     | [hitbbs-front-react(React.js)](https://github.com/atjiu/hitbbs-front-react) ||

## License

GNU AGPLv3 (hitbbs4.0开始，开源协议从MIT更改为GNU AGPLv3)
